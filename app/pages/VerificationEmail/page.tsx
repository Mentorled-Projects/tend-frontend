      ...
      <div className="w-full max-w-md bg-white rounded-md shadow-sm overflow-hidden">
        ...
        <div className="px-6 pb-6">
          ...
          <p className="text-sm text-gray-700 mb-2">
            The verification code will be valid for 20 seconds. Please do not share this code with anyone.
          </p>
          <p className="text-sm text-gray-700 mb-6">
            Don't recognize this activity? Please {" "}
            <Link href="/pages/ForgotPassword" className="text-teal-500 hover:underline">
              Reset Your Password
            </Link> {" "}
